...
"""
JSON parsers for various datatypes
"""
...
def parse_json_item(json_item, schema):
    ...
    if len(terms) != 2:
        raise MesosException('{!r} is not a valid json-item'.format(json_item))
...
class ValueTypeParser(object):
    ...
    def __call__(self, value):
        ...
        if value_type == 'string':
            ...
            raise MesosException('Unknown type {!r}'.format(value_type))
